...
class PParserCommonBlocksTest extends TestCase
{
    ...
    public function testGetAllLinks()
    {
        ...
        $this->assertInstanceOf(PParserCommon::class, $parser);
    ...
    public function makePParserCommonBlocks(string $body = ''): PParserCommon
    {
        return new PParserCommon($body ?: $this->body);
    }
