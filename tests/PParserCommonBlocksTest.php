...
class PParserCommonBlocksTest extends TestCase
{
    ...
    public function makePParserCommonBlocks(string $body ='' ): PParserCommonBlocks
    {
        return new PParserCommonBlocks($body ?: $this->body);
    }
    ...
    public function testGetAllLinks()
    {
        ...
        $this->assertInstanceOf(PParserCommonBlocks::class, $parser);
